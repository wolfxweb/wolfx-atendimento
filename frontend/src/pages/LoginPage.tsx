      ...
      <div className="max-w-md w-full">
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-indigo-600">wolfx.atendimento</h1>
            <p className="text-gray-500 mt-2">Sistema de Tickets & Suporte</p>
          </div>
          ...
          <div className="mt-6 text-center text-sm text-gray-500">
            <p>Contas de teste:</p>
            <p className="mt-1">Admin: admin@wolfx.com / Admin@123</p>
            <p>Cliente: cliente2@wolfx.com / Cliente@123</p>
            <p>Agente: joao.agente@wolfx.com / Agente@123</p>
          </div>
        </div>
      </div>
    </div>
